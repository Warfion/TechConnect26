...
>**Note:** Any links like the one above will send Ctrl+Alt+Delete to the selected machine. This can also be done via the **Keyboard** menu in the upper-left hand corner of the screen.
